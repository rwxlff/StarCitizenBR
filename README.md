...
- **Programa Portátil:** O novo StarCitizenBR 5.2 dispensa instalações, sendo um arquivo único ele pode ser executado em qualquer local.
...
Com o StarCitizenBR, à medida que o Star Citizen evolui, as traduções também são atualizadas automaticamente, proporcionando uma experiência contínua e sem interrupções. O novo StarCitizenBR 5.2 também trás traduções atualizadas em tempo record para manter o jogador sempre atualizado com os patchs mais recentes.
