...
1. Se necessário, configure a exclusão do "StarCitizenBR.exe" no seu antivirus.
   Caso tenha dúvidas, pode verificar todos os arquivos do repositório no <a href="https://www.virustotal.com/gui/url/80f8c8492ee51a2dc271e14f2eddf52496d7041737f2c9ff3bf2b68c5864e4b7?nocache=1" target="_blank">VirusTotal.com</a>
 diretamente pela URL sem baixar o arquivo.

3. Faça o download do StarCitizenBR.exe para sua Área de Trabalho ou para uma pasta de sua escolha e execute-o. Não é necessário instalação pois o StarCitizenBR é um app simples e portátil de arquivo único criado especialmente para a comodidade do usuário.

4. Ao executar o app ele pedirá acesso administrativo para poder operar na pasta do jogo e fará o reconhecimento dos ambientes disponíveis do Star Citizen.
